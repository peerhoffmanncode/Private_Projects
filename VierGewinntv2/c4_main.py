...
def ki_player_move(
    ...
    ki_player: c4_KIPlayer.KIPlayer,
    player_symbol: str,
    main_depth=25,
) -> int:
    """function to get KI Player move"""
    column_to_place_stone = ki_player.ki_player_do_turn(player_symbol)
    print(
...
def main(game_size=7):
    ...
    while True:
        ...
        if played_steps % 2 == 0:
            ...
            #    main_board1, cpu_player, player_symbol, main_depth=50#cpu_player.cpu_depth
            #)

            # Human player call
            column_to_place_a_stone = user_input(main_board1.board_size_x)
        else:
